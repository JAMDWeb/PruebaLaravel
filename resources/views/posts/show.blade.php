...
>
    <h1 class="my-4 font-serif text-3xl text-center text-sky-600
         dark:text-sky-500">{{ $post->title }}</h1>

    <div class="flex flex-col max-w-xl px-8 py-4 mx-auto bg-white rounded
            shadow h-96 dark:bg-slate-800">
    ...
    {{-- es bueno acceder a rutas con nombre en lugar de la url --}}
        <a class="mr-auto text-sm font-semibold underline border-2 border-transparent

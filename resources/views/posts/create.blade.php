...
>
    <h1 class="my-4 font-serif text-3xl text-center text-sky-600
        dark:text-sky-500">Create new post</h1>

{{-- para mostrar errores larravel tenemos una variable especial que esta disponible en todasla vistas --}}
    ...
    <form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow
        dark:bg-slate-800" action="{{ route('posts.store') }}"
        method="POST">
